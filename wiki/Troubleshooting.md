...
If your issue is not covered here, ask on
**[Discord](https://discord.gg/9QZEzVwdnt)** or open an issue.
...
2. On older Windows systems, or if `.local` still fails, install
   **[Bonjour Print Services](https://support.apple.com/kb/DL999)** or use the
   Pi's IP address directly.
...
**Try:**
1. **Check the cable** — use a **USB-C data cable**, not a charge-only cable.
...
Dash USB snapshots recordings every 15 minutes and archives them to your server.
Preserved footage is under **Viewer → Recordings** and on the archive server,
not on the virtual drive exposed to the car.
...
3. From the Pi, try mounting manually:
   ...
   ```
   Use the resulting error to diagnose the mount failure.

## Still stuck?

- **[Discord](https://discord.gg/9QZEzVwdnt)** — community help
